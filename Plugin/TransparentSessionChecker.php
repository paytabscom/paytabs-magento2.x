...
/**
 * Intended to preserve session cookie after submitting POST form from ClickPay to Magento controller.
 */
class TransparentSessionChecker
{
    ...
    /**
     * Prevents session starting while instantiating ClickPay transparent redirect controller.
     *
